package xml.authorship.service.authorship.service.db;
...
public class ExistManager {
    ...
    public void storeFromAuthorshipRequest(AuthorshipRequest authorshipRequest) throws Exception {
//        String collectionId = "/db/request/authorship";
        String documentId = "113.xml"; //generate authorship xml
        ...
        try {
            ...
            os = loader.marshalling(authorshipRequest, os);
