...
import xml.main.main.service.jaxb.Loader;
...
public class ExistManager {
    ...
    public void storeFromPatentRequest(Users patentRequest) throws Exception {
    ...
    public Users retrieve(String documentId) throws Exception {
        createConnection();
        Collection col = null;
        XMLResource res = null;
        ...
        try {
            ...
            if (res == null) {
                ...
                Users request = loader.unmarshalling((String) res.getContent());
                return request;
            }
        } finally {
            closeConnection(col, res);
